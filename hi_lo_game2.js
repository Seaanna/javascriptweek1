...
function submitName(){
  ...
  document.getElementById("outputName").innerHTML = "Hello, " + userName + "!";
}
...
function checkNumber() {
  ...
  if (parseInt(userGuess) == randomNumber) {
    document.getElementById("notification").innerHTML = "Your answer is correct! Good job, " + userName + "!";
    document.getElementById("inputFieldNumber").value = " ";
  }

  // If user attempts to guess more than 5 times, execute the following:
  if (userAttempts>5) {
    document.getElementById("notification").innerHTML = "Loooooser!";
    document.getElementById("inputFieldNumber").value = " ";
